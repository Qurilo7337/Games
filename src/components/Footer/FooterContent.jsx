  ...
  return (
    <div className='pt-5' style={{ background: '#12294a' }}>
      <div className="px-md-5 px-3">
        <div className="row">
          <div className="col-md-3 col-12 pb-3 pb-md-0 text-left">
            ...
            <button className="my-2 px-4 SSA_footer_transclusentBtn ms-2" >
          ...
          {footerContent.map((column, index) => (
            <div key={index} className="col col-md-2 col-sm-6 col-6 text-left">
              ...
              {column.content.map((item, i) => (
                <div key={i} className='SSA_colorGrey SSA_Font_15px' style={{cursor:"pointer"}}>{item}</div>
              ))}
              <br />
            </div>
          ))}
      ...
      <div>
        ...
        <p className="mb-2 text-center text-white flex justify-center items-center gap-2 text-sm lg:text-base fs-3"> Designed and Developed By <a href={"https://www.qurilo.com/"} ><img width={140} height={140} src="https://imagedelivery.net/GbbYdP_HsqaVUbISP6-ZdA/cdc8758b-1179-4b48-5899-8aca155f2200/public" /></a> </p>
        <p className='copyright text-white text-center mb-2 text-sm lg:text-base  pb-4'>Copyright © 2023 Bluechip All Rights Reserved</p>
      </div>
    </div>
  )
}
